            ...
            <div class="img-fill">
                ...
                <div class="text-content">
                  <div data-scroll-reveal="enter bottom and scale up 80% over 1.5s">
                    <h3>Welcome To Crow</h3>
                    <h5>Flexible Working in the Heart of Crawley</h5>
                    <a href="locations.php" class="main-stroked-button">Learn More</a>
                  </div>
                </div>
            </div>
          </div>
            ...
            <div class="row">
                ...
                <div data-scroll-reveal="enter bottom and scale up 80% over 1.5s" class="col-lg-12 col-md-12 col-xs-12">
                    <div class="text-center">
                        <p>As a member of Pavilion business members’ club you will enjoy luxurious professional spaces, unparalleled service, state-of-the-art technology and access to exclusive member-only events and facilities.
                      <br><br>Whether you are using Pavilion as an occasional base in London or as your permanent private office, we have aimed to create the perfect space for like-minded people to work.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-4 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <ul class="contact-info">
                            <li><span class="material-icons pr-5">
                                call
                                </span>010-020-0860</li>
                            <li><span class="material-icons pr-5">
                                email
                                </span>info@company.com</li>
                            <li><span class="material-icons pr-5">
                                public
                                </span>www.company.com</li>
                        </ul>
                    </div>
                </div>
